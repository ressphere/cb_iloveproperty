...
class furnished_type_model extends cb_base_module_model {
    // ------------ Setup Function ---------------------------------------------
    public $model_name = "furnished_type";
    public $model_code = "MFT";
    ...
    {
        $column_list = array (
            array("name" => "furnished_type", "must_have" => true, "is_id" => false),
        );
...
class furnished_type_record_model extends Base_module_record
{
}
