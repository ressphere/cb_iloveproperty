...
class facilities_model extends cb_base_module_model {
    // ------------ Setup Function ---------------------------------------------
    public $model_name = "facilities";
    public $model_code = "MF";
...
class facilities_model_model_record_model extends Base_module_record
{
}
