...
class land_title_type_model extends cb_base_module_model {
    // ------------ Setup Function ---------------------------------------------
    public $model_name = "land_title_type";
    public $model_code = "MLTT";
    ...
    {
        $column_list = array (
            array("name" => "land_title_type", "must_have" => true, "is_id" => false),
        );
...
class land_title_type_record_model extends Base_module_record
{
}
