...
class reserve_type_model extends cb_base_module_model {
    // ------------ Setup Function ---------------------------------------------
    public $model_name = "reserve_type";
    public $model_code = "MRET";
    ...
    {
        $column_list = array (
            array("name" => "reserve_type", "must_have" => true, "is_id" => false),
        );
...
class reserve_type_record_model extends Base_module_record
{
}
