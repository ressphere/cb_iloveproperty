...
class property_type_model extends cb_base_module_model {
    // ------------ Setup Function ---------------------------------------------
    public $model_name = "property_type";
    public $model_code = "MPT";
    ...
    {
        $column_list = array (
            array("name" => "property_type", "must_have" => true, "is_id" => false),
            array("name" => "property_category", "must_have" => false, "is_id" => false),
            array("name" => "service_type", "must_have" => false, "is_id" => false),
        );
...
class property_type_record_model extends Base_module_record
{
}
