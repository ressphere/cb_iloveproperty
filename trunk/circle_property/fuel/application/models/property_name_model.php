...
class property_name_model extends cb_base_module_model {
    // ------------ Setup Function ---------------------------------------------
    public $model_name = "property_name";
    public $model_code = "MPN";
    ...
    {
        $column_list = array (
            array("name" => "property_name", "must_have" => true, "is_id" => false),
        );
...
class property_name_record_model extends Base_module_record
{
}
?>
