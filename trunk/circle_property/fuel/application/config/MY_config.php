...
//webservice path
$config['webservice'] = 'http://localhost/cb_iloveproperty/trunk/circle_property';

// Determine error message string display is developer or user
// ** Currently not use, prepare for phase 2 refectoring **
$config['display_user_error'] = FALSE;

// For benchmarking purpose
$config['dump_benchmark_file'] = FALSE;
...
|--------------------------------------------------------------------------
*/
$config['captcha_path'] = 'assets/images/captcha';
$config['captcha_fonts_path'] = 'captcha/fonts/captcha4.ttf';
$config['captcha_width'] = 200;
$config['captcha_height'] = 50;
$config['captcha_font_size'] = 10;
