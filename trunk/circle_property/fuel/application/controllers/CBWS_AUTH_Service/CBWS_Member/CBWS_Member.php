...
class CBWS_Member {
    ...
    public function get_user_property_listing_limit($user_id)
    {
     ...
     public function get_user_property_sms_limit($user_id, $service)
    {

        return $this->CI->tank_auth->get_user_sms_limit($user_id, $service);
    }
    
    public function deduct_property_sms_limit($user_id)
    {
        return $this->CI->tank_auth->deduct_property_sms_limit($user_id);
    }
