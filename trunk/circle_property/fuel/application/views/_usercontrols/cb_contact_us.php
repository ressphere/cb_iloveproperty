<div id="contact" class="unfixed_content container-fluid">
        ...
        <form id="ressphere_contact_form" class="form-horizontal" action="<?php echo $post_link?>" method="post">
            ...
            <?php
                ...
                echo '  <div class="col-md-6">';
                    echo '<textarea id="contact_us_msg" maxlength="500" id="contact_us_input_'.$message_id.'"rows="14" class="contact_us_textarea" value="" class="form-control" placeholder="'. $contact_list[$message_id][1] . '"></textarea>';
                echo '</div>';
          ?>
            </div><br>
           <div class="row clearfix">
