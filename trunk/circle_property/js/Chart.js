...
window.Chart = function(context){
	...
	var Doughnut = function(data,config,ctx){
		...
		for (var i=0; i<data.length; i++){
			var range = [];
                        range.push(segmentTotal * Math.PI / 180);
                        segmentTotal += data[i].value;
                        range.push(segmentTotal * Math.PI / 180);
                        data_angle.push(range);
		}
		...
		animationLoop(config,null,drawPieSegments,ctx);
                ...
                this.get_segmentTotal = function()
                {
                    return segmentTotal;
                };
                this.get_doughnutRadius = function()
                {
                    return doughnutRadius;
                };
                this.get_cutoutRadius = function ()
                {
                    return cutoutRadius;
                };
                ...
                this.get_segmentAngleList = function()
                {
                    return data_angle;
                };
