...
VALUES ("<strong>Ressphere</strong> is founded on 17th of March, 2014.<BR> 
           ...
           <br> 
           Its name is derived from &ldquo;Resonance/Resolution&rdquo; and &ldquo;Sphere&rdquo; which symbolizes a society that contains people from all around the world where they can work together to achieve consensus that bring the best solution to each other.
           <br><br> 
...
INSERT INTO CB_Home_video (`type`, content_path, content_display_path) VALUES ('video',  NULL, 'http://www.youtube.com/embed/8DPuweQkBE8');
