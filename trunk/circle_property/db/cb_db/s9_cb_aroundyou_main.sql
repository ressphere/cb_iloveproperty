...
CREATE TABLE IF NOT EXISTS `aroundyou_company` (
    ...
    `aroundyou_company__operation_time_start` tinyint(4),
    `aroundyou_company__operation_time_end` tinyint(4),
    ...
    `aroundyou_company__product_count` int default 0,
...
CREATE TABLE IF NOT EXISTS `aroundyou_users` (
    ...
    `aroundyou_users__company_count` int NOT NULL DEFAULT '0',
