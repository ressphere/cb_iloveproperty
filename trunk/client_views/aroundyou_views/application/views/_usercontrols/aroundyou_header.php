<div>
    ...
    <!--                            <li role="presentation">
        ...
        <div class="row col-md-12" id="aroundyou_header_nav_bar" style="margin-left: 0px; margin-right: 0px">
            <ul class="nav navbar-nav navbar-right header_menu" id="aroundyou_header_nav_menu">
                    <li><a class="state" id="tmp1" target = "_top" style="padding: 10px 29px;">temp1</a></li>
                    <li><a class="state" id="tmp2" target = "_top" style="padding: 10px 29px;">temp2</a></li>
                    <li><a class="state" id="tmp3" target = "_top" style="padding: 10px 29px;">temp3</a></li>
                    <li><a class="state" id="tmp4" target = "_top" style="padding: 10px 29px;">temp4</a></li>
