             ...
             <div  class="drop row clearfix" flow-drop="" ng-class="dropClass">
                ...
                <div>
                    <div ng-repeat="file in $flow.files" class="col-sm-6 col-md-4">
                          ...
                          <div>
                              <center><textarea maxlength="200" class="form-control photo-desc" maxlength="50" style='resize: none;' cols='35' rows='5' placeholder='Describe Your Photo Here'></textarea></center>
                          </div>
                          <br>
