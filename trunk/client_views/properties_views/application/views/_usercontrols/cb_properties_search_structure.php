                                                  ...
                                                  <div id="collapse_{{change_to_id_class(country_data)}}" class="panel-collapse collapse" ng-class="is_requie_expend_country(country_data)">
                                                    <div class="panel-body">
                                                        <div class="list-group">
                                                            <a ng-click="update_contry_state(country_data, state_data)" class="state_group_list list-group-item" ng-class="is_requie_highlight_state(country_data, state_data)" ng-repeat="state_data in state_array" style="background-color:#eff0f5; border-color:#d8d8d8; font-family:'Century Gothic' ; color: #000;"> {{state_data}}</a>
                                                        </div>
                                                    </div>
                                                  </div>
                                                </div>
